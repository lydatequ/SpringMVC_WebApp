package com.javabycode.springmvctrn.controller;
...
import com.javabycode.springmvctrn.service.TrainerService;
...
public class MyController {
	...
	public String saveTrainer(@Valid Trainer trainer, BindingResult result,
		...
		model.addAttribute("success", "Trainer " + trainer.getFirstName() + trainer.getLastName() + " registered successfully");
		return "success";
	}
	...
	public String editTrainer(@PathVariable int id, ModelMap model) {
		Trainer trainer = service.editTrainerById(id);
		model.addAttribute("trainer", trainer);
	...
	public String updateTrainer(@Valid Trainer trainer, BindingResult result,
		...
		model.addAttribute("success", "Trainer " + trainer.getFirstName() + " " + trainer.getLastName() + " updated successfully");
		return "success";
	}
